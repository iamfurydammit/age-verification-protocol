...
Age is verified once using government identification and a liveness check.
...
1. One-Time Age Verification (Issuance)
...
Licensing details will be specified in the repository root.
